...
@Component({
  selector: 'd3-area-line-chart',
  templateUrl: './d3AreaLineChart.component.html',
  styleUrls: ['./d3AreaLineChart.component.scss']
})
export class D3AreaLineChartComponent implements OnChanges, OnInit {
  ...
  ngOnInit() {
    ...
    this.area = D3.area()
      ...
      .y0(this.chartHeight)
      .y1((d: any) => { return this.yScale(d.close); });
